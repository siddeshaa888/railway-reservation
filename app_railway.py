...
# Railway auto-injects these when you add a MySQL service
# ─────────────────────────────────────────────────────────────
DB_CONFIG = {
    "host":     os.environ.get("MYSQLHOST",     "localhost"),
    "port":     int(os.environ.get("MYSQLPORT", 3306)),
    "user":     os.environ.get("MYSQLUSER",     "root"),
    "password": os.environ.get("MYSQLPASSWORD", "nmit1234"),
    "database": os.environ.get("MYSQLDATABASE", "railway_db"),
    "charset":  "utf8mb4",
}
...
def register_passenger():
    ...
    try:
        ...
        return jsonify({"success": True, "passenger_id": pid,
                        "message": f"Registered with ID {pid}"})
    except Error as e:
        return jsonify({"success": False, "error": str(e)}), 500


# ─────────────────────────────────────────────────────────────
# API — Find Passenger by Email
# ─────────────────────────────────────────────────────────────
